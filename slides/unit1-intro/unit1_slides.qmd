...
format:
  revealjs:
    ...
    slide-number: true
    incremental: true
    footer: "EC325 | Fall 2026 | Unit 1: Introduction"
execute:
  echo: false
  warning: false
  message: false
...
This is my second year at Colby!
...
- Office Hours: Tuesdays and Thursdays, 1:30pm - 3:30pm, Fridays, 10:00am - 12:00pm. Or by [appointment](https://calendar.app.google/x2kBXD8Ma9XwABVh9).

# What is Econometrics?

## What is this Class About?

From a classic textbook:
...
Modern econometrics has really focused on developing techniques to identify the **causal effects** of social phenomena/policy as opposed to **correlations**

. . .

What do we mean by **causal effects**? Let's think through an example...
...
## Other examples of causal inference questions we will discuss

::: {.incremental}
- Does a getting a college degree cause someone to have a higher wage?
- Is immigration bad for native workers wages?
- Do police reduce crime?
:::

# How Do We Do Econometrics?

## What Is the Process for an Econometric Analysis?
...
::: {.incremental}
- cross-sectional (most common, our focus for most of the semester): a sample of individuals, households, firms, countries, or any other unit observed at a single, given point in time
- Data for econometric is organized (or *needs to be organized*) as a **matrix** or **dataframe** (very similar to a spreadsheet!)
:::

```{r}
#| label: create-test-data

test_data <- tibble("pid" = c(1, 2, 3, 4),
...
test_data |>
  knitr::kable(
    format = "html",
    col.names = c("Person ID", "Wage", "Education",
                  "Experience", "Training"),
    align = "ccccc",
    digits = 2
  )
...
Important questions to ask: what does each row represent? What about each column?
...
Once we have our data, we need to *explore* and *understand it*
...
- In our made-up estimate above, each additional year of education suggests an increase in wages of 11%
- More importantly: what does this *really* mean? Is it big or small? Is it economically important?
:::
...
- Alternative ways of causal methods: instrumental variables and regression discontinuities
- Time Series Methods
:::
...
- Tucker Reinhard and Othar Zaldastani
...
- Essential skill for research and industry jobs
- You can easily grab the most-updated versions of the course materials 

## Lecture Notes

- You are required the read the lecture notes for this course *before we cover the unit in class*

- The notes are available at: [https://www.raymondcaraher.com/ec325/](https://www.raymondcaraher.com/ec325/) or in your Git directory on your computer
...
- Due each Sunday at 11:59pm (with some exceptions)
...
You can work in groups on problem sets, but please turn in an individual copy of your work.


## Exams

- In-class Midterm exam (tentative date: Thursday, Oct. 15)
- Final exam (per Registrar schedule)
- One double-sided, hand-written reference sheet is allowed
...
After the midterm, I will assign a "preliminary" EL grade in Moodle so you know where you are at and what you may need to change
...
1. "Clean" our data and organize it in a format so we can do econometric analysis
2. Explore our data using descriptive statistics and data visualizations
3. Estimate our models and calculate the statistical uncertainty
4. Output our results as tables and figures so we can present and interpret them in their *broader context*
...
**R** is the engine; **RStudio** is the driver's seat


## AI Policy {.smaller}

- AI tools can be useful for coding questions, but over-reliance can become a crutch. 
- [Stromberg et al. (2026)](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6977138): Students who use AI have higher homework scores and complete homework quicker,
but have lower exam scores and higher learning loss in the short and long run,
*with social science students experiencing the largest decreases*

. . .

The AI policy for this course is:
...
- You **must understand** the code you submit (you will have to read and interpret code on the exams!)
...
1. Name
2. Pronoun
3. Your summer highlight

## For Next Time

- Read **Unit 1: Introduction, Unit 2: Good Data Practices, and Appendix B: Statistics and Probability Review** of the lecture notes (will help with Concept Check 1!)
- Follow the [EC325 Installation Guide](https://www.raymondcaraher.com/ec325/ec325_installation_guide.html) to get set up with R, RStudio, and Git!
- Concept Check 1 (review of Key Concepts from statistics - due this Sunday (the 13th) at 11:59pm)
- Fill out the [First Day Survey](https://forms.gle/cW1LadxiySCFWAtD9) so I can create final project groups
