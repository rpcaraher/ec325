...
test_data |>
  knitr::kable(
    format = "html",
    col.names = c("Person", "Wage ($/hr)", "Education (yrs)",
                  "Experience (yrs)", "Training (weeks)"),
    align = "ccccc",
    digits = 2
  )
```
...
::: {.column width="28%"}
::: {.smaller}
Each **row** is an *observation* (a person)
...
- Read **unit 1 and unit 2** of the lecture notes (will help with Concept Check 1!)
...
- Concept Check 1 (review of Key Concepts from Statistics - due this Sunday!)
